...
Environment constant 20 identical agents, each with its own copy of the environment.  
...
Follow the instructions in `train.ipynb` to get started with training your own agent!  
